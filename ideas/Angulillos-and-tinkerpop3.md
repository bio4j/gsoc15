...
[Angulillos](https://github.com/bio4j/angulillos) is a strongly-typed generic API for working with typed graphs, used extensively across Bio4j. Methods return Java 8 Streams of the corresponding edge/vertex types, and in/out methods can only be called if the target/source types of the corresponding types match.
